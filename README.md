...
- The theme is `daveverwer` rather than `simple`, because it shows the hostname. The load balancer moves you between nodes, so the prompt says which one you are on
